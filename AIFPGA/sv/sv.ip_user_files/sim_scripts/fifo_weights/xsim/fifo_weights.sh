...
elaborate()
{
  xelab --relax --debug typical --mt auto -L fifo_generator_v13_2_3 -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot fifo_weights xil_defaultlib.fifo_weights xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim fifo_weights -key {Behavioral:sim_1:Functional:fifo_weights} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_268b.protoinst" -protoinst "protoinst_files/DDR_Block.protoinst" -protoinst "protoinst_files/bd_8d04.protoinst" -protoinst "protoinst_files/Block_test.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb fifo_weights.wdb xsim.dir)

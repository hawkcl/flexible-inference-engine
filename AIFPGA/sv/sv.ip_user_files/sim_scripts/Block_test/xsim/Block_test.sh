...
elaborate()
{
  xelab --relax --debug typical --mt auto -L axi_infrastructure_v1_1_0 -L fifo_generator_v13_2_3 -L axi_clock_converter_v2_1_17 -L xil_defaultlib -L lib_cdc_v1_0_2 -L proc_sys_reset_v5_0_13 -L xlconstant_v1_1_5 -L smartconnect_v1_0 -L generic_baseblocks_v2_1_0 -L axi_data_fifo_v2_1_17 -L axi_register_slice_v2_1_18 -L axi_protocol_converter_v2_1_18 -L blk_mem_gen_v8_4_2 -L axi_dwidth_converter_v2_1_18 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot Block_test xil_defaultlib.Block_test xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim Block_test -key {Behavioral:sim_1:Functional:Block_test} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_268b.protoinst" -protoinst "protoinst_files/DDR_Block.protoinst" -protoinst "protoinst_files/bd_8d04.protoinst" -protoinst "protoinst_files/Block_test.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb Block_test.wdb xsim.dir)

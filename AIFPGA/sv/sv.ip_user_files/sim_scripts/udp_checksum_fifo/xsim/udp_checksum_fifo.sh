...
#
# Generated by Vivado on Mon Oct 21 13:34:10 +0800 2019
...
# Script info
echo -e "udp_checksum_fifo.sh - Script generated by export_simulation (Vivado v2018.3 (64-bit)-id)\n"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L fifo_generator_v13_2_3 -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot udp_checksum_fifo xil_defaultlib.udp_checksum_fifo xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim udp_checksum_fifo -key {Behavioral:sim_1:Functional:udp_checksum_fifo} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_268b.protoinst" -protoinst "protoinst_files/DDR_Block.protoinst" -log simulate.log
}

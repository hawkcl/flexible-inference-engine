...
elaborate()
{
  xelab --relax --debug typical --mt auto -L fifo_generator_v13_2_3 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot fifo_DDRWriteInfo xil_defaultlib.fifo_DDRWriteInfo xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim fifo_DDRWriteInfo -key {Behavioral:sim_1:Functional:fifo_DDRWriteInfo} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_268b.protoinst" -protoinst "protoinst_files/DDR_Block.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb fifo_DDRWriteInfo.wdb xsim.dir)

...
################################################################
# This is a generated script based on design: Block_test
#
...
proc write_mig_file_Block_test_mig_7series_0_0 { str_mig_prj_filepath } {
   ...
   puts $mig_prj_file {  <ModuleName>Block_test_mig_7series_0_0</ModuleName>}
...
# End of write_mig_file_Block_test_mig_7series_0_0()
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {S1_AXI:PS_AXI:S0_AXI} \
 ] $ui_clk
  ...
  write_mig_file_Block_test_mig_7series_0_0 $str_mig_file_path
  ...
  connect_bd_intf_net -intf_net PS_AXI_1 [get_bd_intf_ports PS_AXI] [get_bd_intf_pins axi_dwidth_converter_0/S_AXI]
  ...
  connect_bd_intf_net -intf_net axi_dwidth_converter_0_M_AXI [get_bd_intf_pins axi_clock_converter_2/S_AXI] [get_bd_intf_pins axi_dwidth_converter_0/M_AXI]
  ...
  connect_bd_net -net mig_7series_0_ui_addn_clk_0 [get_bd_ports ui_clk] [get_bd_pins axi_clock_converter_0/s_axi_aclk] [get_bd_pins axi_clock_converter_1/s_axi_aclk] [get_bd_pins axi_clock_converter_2/s_axi_aclk] [get_bd_pins axi_dwidth_converter_0/s_axi_aclk] [get_bd_pins mig_7series_0/ui_addn_clk_0] [get_bd_pins proc_sys_reset_0/slowest_sync_clk]
  connect_bd_net -net mig_7series_0_ui_clk [get_bd_pins axi_clock_converter_0/m_axi_aclk] [get_bd_pins axi_clock_converter_1/m_axi_aclk] [get_bd_pins axi_clock_converter_2/m_axi_aclk] [get_bd_pins mig_7series_0/ui_clk] [get_bd_pins smartconnect_0/aclk]
  ...
  connect_bd_net -net proc_sys_reset_0_interconnect_aresetn [get_bd_pins axi_clock_converter_0/m_axi_aresetn] [get_bd_pins axi_clock_converter_0/s_axi_aresetn] [get_bd_pins axi_clock_converter_1/m_axi_aresetn] [get_bd_pins axi_clock_converter_1/s_axi_aresetn] [get_bd_pins axi_clock_converter_2/m_axi_aresetn] [get_bd_pins axi_clock_converter_2/s_axi_aresetn] [get_bd_pins axi_dwidth_converter_0/s_axi_aresetn] [get_bd_pins proc_sys_reset_0/interconnect_aresetn] [get_bd_pins smartconnect_0/aresetn]
  ...
  create_bd_addr_seg -range 0x40000000 -offset 0x80000000 [get_bd_addr_spaces PS_AXI] [get_bd_addr_segs mig_7series_0/memmap/memaddr] SEG_mig_7series_0_memaddr

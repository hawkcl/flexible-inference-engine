...
//Command     : generate_target DDR_Block.bd
//Design      : DDR_Block
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "DDR_Block,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=DDR_Block,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=7,numReposBlks=7,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "DDR_Block.hwdef" *) 
module DDR_Block
   (ACLK_PS,
    DDR3_addr,
    DDR3_ba,
    ...
    ui_clk,
    ui_clk_sync_rst);
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.ACLK_PS CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.ACLK_PS, CLK_DOMAIN DDR_Block_S_AXI_HP0_ACLK_0, FREQ_HZ 150000000, INSERT_VIP 0, PHASE 0.000" *) input ACLK_PS;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.FCLK_CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.FCLK_CLK, CLK_DOMAIN DDR_Block_processing_system7_0_0_FCLK_CLK0, FREQ_HZ 150000000, INSERT_VIP 0, PHASE 0.000" *) output FCLK_CLK;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 S0_AXI ARADDR" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME S0_AXI, ADDR_WIDTH 32, ARUSER_WIDTH 0, AWUSER_WIDTH 0, BUSER_WIDTH 0, CLK_DOMAIN DDR_Block_mig_7series_0_0_ui_clk, DATA_WIDTH 256, FREQ_HZ 57657662, HAS_BRESP 1, HAS_BURST 1, HAS_CACHE 1, HAS_LOCK 1, HAS_PROT 1, HAS_QOS 1, HAS_REGION 1, HAS_RRESP 1, HAS_WSTRB 1, ID_WIDTH 0, INSERT_VIP 0, MAX_BURST_LENGTH 256, NUM_READ_OUTSTANDING 1, NUM_READ_THREADS 1, NUM_WRITE_OUTSTANDING 1, NUM_WRITE_THREADS 1, PHASE 0, PROTOCOL AXI4, READ_WRITE_MODE READ_WRITE, RUSER_BITS_PER_BYTE 0, RUSER_WIDTH 0, SUPPORTS_NARROW_BURST 1, WUSER_BITS_PER_BYTE 0, WUSER_WIDTH 0" *) input [31:0]S0_AXI_araddr;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.UI_CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.UI_CLK, ASSOCIATED_BUSIF S1_AXI:S0_AXI:PS_AXI, CLK_DOMAIN DDR_Block_mig_7series_0_0_ui_clk, FREQ_HZ 57657662, INSERT_VIP 0, PHASE 0" *) output ui_clk;
  ...
  assign FCLK_CLK = processing_system7_0_FCLK_CLK0;
  ...
  DDR_Block_axi_clock_converter_0_0 axi_clock_converter_0
  ...
  DDR_Block_axi_clock_converter_1_0 axi_clock_converter_1
       (.m_axi_aclk(mig_7series_0_ui_clk),
  ...
  DDR_Block_axi_protocol_convert_0_0 axi_protocol_convert_0
  ...
  DDR_Block_mig_7series_0_0 mig_7series_0
       (.aresetn(proc_sys_reset_0_peripheral_aresetn),
  ...
  DDR_Block_proc_sys_reset_0_0 proc_sys_reset_0
       (.aux_reset_in(1'b1),
  ...
  DDR_Block_processing_system7_0_0 processing_system7_0
       (.DDR_Addr(DDR_PS_addr[14:0]),
        ...
        .S_AXI_HP0_ACLK(mig_7series_0_ui_addn_clk_0),
  ...
  DDR_Block_smartconnect_0_0 smartconnect_0

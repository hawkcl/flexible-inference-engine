...
#ifndef MTI_INCLUDED_TYPEDEF_bm_inputs
#define MTI_INCLUDED_TYPEDEF_bm_inputs
...
#ifndef MTI_INCLUDED_TYPEDEF_bm_outputs
#define MTI_INCLUDED_TYPEDEF_bm_outputs

typedef struct {
    svLogicVecVal receivedBM[SV_PACKED_DATA_NELEMS(11)];

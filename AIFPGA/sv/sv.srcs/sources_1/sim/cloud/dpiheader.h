...
typedef struct {
    ...
    svLogicVecVal wLRelu[SV_PACKED_DATA_NELEMS(16)];
...
typedef struct {
    ...
    svLogicVecVal len[SV_PACKED_DATA_NELEMS(8)];
    svLogicVecVal token[SV_PACKED_DATA_NELEMS(8)];
    svLogicVecVal data[28][SV_PACKED_DATA_NELEMS(16)];
}  ReturnData_t_unpack;

#endif

#ifndef MTI_INCLUDED_TYPEDEF_cloud_inputs
#define MTI_INCLUDED_TYPEDEF_cloud_inputs
...
#ifndef MTI_INCLUDED_TYPEDEF_cloud_outputs
#define MTI_INCLUDED_TYPEDEF_cloud_outputs

...
#ifndef MTI_INCLUDED_TYPEDEF_assembleInput_inputs
#define MTI_INCLUDED_TYPEDEF_assembleInput_inputs
...
typedef struct {
    ...
    svLogicVecVal data_input[12][SV_PACKED_DATA_NELEMS(8)];
...
#ifndef MTI_INCLUDED_TYPEDEF_assembleInput_outputs
#define MTI_INCLUDED_TYPEDEF_assembleInput_outputs

typedef struct {
    svLogic buffer_wen;
    svLogicVecVal buffer_data[12][SV_PACKED_DATA_NELEMS(8)];
    svLogic ren;
...
void
compare_outputs(
    const assembleInput_outputs* out_data);

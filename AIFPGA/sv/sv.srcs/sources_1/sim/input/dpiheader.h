...
#ifndef MTI_INCLUDED_TYPEDEF_input_inputs
#define MTI_INCLUDED_TYPEDEF_input_inputs
...
typedef struct {
    ...
    svLogic new_params_readFeatures;
    svLogicVecVal readPos[SV_PACKED_DATA_NELEMS(5)];
    svLogicVecVal volumeSize[SV_PACKED_DATA_NELEMS(17)];
    ...
    svLogicVecVal outputBufH1[SV_PACKED_DATA_NELEMS(4)];
...
#ifndef MTI_INCLUDED_TYPEDEF_input_outputs
#define MTI_INCLUDED_TYPEDEF_input_outputs
...
typedef struct {
    ...
    svLogicVecVal backupBus[7][SV_PACKED_DATA_NELEMS(8)];
    ...
    svLogicVecVal atmpSize[SV_PACKED_DATA_NELEMS(4)];
    svLogicVecVal curRowCount[SV_PACKED_DATA_NELEMS(5)];
    svLogicVecVal addrNextFrame[SV_PACKED_DATA_NELEMS(17)];
    svLogicVecVal addrCurAssemble[SV_PACKED_DATA_NELEMS(17)];
    svLogicVecVal iLayers[SV_PACKED_DATA_NELEMS(11)];
    svLogicVecVal rowAddr[SV_PACKED_DATA_NELEMS(6)];
    svLogic rf_wen;
    svLogicVecVal rf_addrOut[SV_PACKED_DATA_NELEMS(13)];
    svLogicVecVal rf_dataOut[12][SV_PACKED_DATA_NELEMS(8)];
    svLogic input_ren;
    svLogic assemble_buff_wen;
    svLogic assemble_buff_ren;
    svLogic is_assemble_buff_full;
    svLogic is_assemble_buff_empty;
    svLogic inputfifo_wen;
    svLogic inputfifo_ren;
    svLogic is_input_fifo_full;
    svLogic is_input_fifo_empty;
    svLogic inputs_buffer_progfull;
    svLogic inputs_buffer_wen;
    svLogic inputs_buffer_ren;
    svLogic inputs_buffer_empty;
    svLogicVecVal inputs_raddr[SV_PACKED_DATA_NELEMS(14)];
    svLogic input_requested;
    svLogicVecVal addrNextAssemble[SV_PACKED_DATA_NELEMS(14)];
}  input_outputs;

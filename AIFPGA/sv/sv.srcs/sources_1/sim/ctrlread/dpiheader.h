...
#ifndef MTI_INCLUDED_TYPEDEF_ctrlread_inputs
#define MTI_INCLUDED_TYPEDEF_ctrlread_inputs

typedef struct {
    svLogic crinst_enable;
    InstructionRead_unpack crinst;
    svLogic cb_isRunning[4];
    svLogic cb_isReadingFeatures[4];
    svLogic cb_isLoadingFroze[4];
    svLogicVecVal cb_ReqFeature[4][SV_PACKED_DATA_NELEMS(11)];
    svLogicVecVal cb_FinishedSeq[4][SV_PACKED_DATA_NELEMS(11)];
    svLogicVecVal cb_WorkingSeq[4][SV_PACKED_DATA_NELEMS(11)];
    svLogicVecVal cb_WorkingProgress[4][SV_PACKED_DATA_NELEMS(11)];
    svLogicVecVal requestValid[SV_PACKED_DATA_NELEMS(4)];
    RequestItem_t_unpack ritem[4];
    svLogic reqGIBValid;
    RequestItem_t_unpack reqGIB;
    svLogic ddr_read_ready;
    svLogicVecVal ddr_data_id[SV_PACKED_DATA_NELEMS(4)];
    svLogicVecVal ddr_data[33][SV_PACKED_DATA_NELEMS(8)];
    svLogicVecVal rama_data[33][SV_PACKED_DATA_NELEMS(8)];
    svLogicVecVal ramb_data[33][SV_PACKED_DATA_NELEMS(8)];
}  ctrlread_inputs;

#endif

#ifndef MTI_INCLUDED_TYPEDEF_ctrlread_outputs
#define MTI_INCLUDED_TYPEDEF_ctrlread_outputs

typedef struct {
    svLogic ddr_enable;
    svLogicVecVal ddr_addr[SV_PACKED_DATA_NELEMS(26)];
    svLogicVecVal ddr_len[SV_PACKED_DATA_NELEMS(6)];
    svLogicVecVal ddr_id[SV_PACKED_DATA_NELEMS(4)];
    svLogic rama_ren;
    svLogic ramb_ren;
    svLogicVecVal ram_addr[SV_PACKED_DATA_NELEMS(26)];
    svLogicVecVal ram_len[SV_PACKED_DATA_NELEMS(6)];
    svLogic pread_waitForSeq;
    ...
    svLogicVecVal data_bus[33][SV_PACKED_DATA_NELEMS(8)];
    ReturnData_t_unpack reqdata;
    svLogic reqGIBValid;
    svLogic input_data_fifo_ren;
    svLogic input_data_fifo_wen;
    svLogicVecVal liveCount[SV_PACKED_DATA_NELEMS(7)];
    svLogic readMoreData;
    svLogic newReqSeq;
    svLogic data_fifo_ren;
    svLogic data_fifo_wen;
}  ctrlread_outputs;
...
void
compare_outputs(
    const ctrlread_outputs* out_data);

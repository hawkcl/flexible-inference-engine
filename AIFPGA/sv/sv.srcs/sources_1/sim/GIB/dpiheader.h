...
#ifndef MTI_INCLUDED_TYPEDEF_GIB_inputs
#define MTI_INCLUDED_TYPEDEF_GIB_inputs

typedef struct {
    svLogicVecVal rama_finishedSeq[SV_PACKED_DATA_NELEMS(11)];
    svLogicVecVal ramb_finishedSeq[SV_PACKED_DATA_NELEMS(11)];
    svLogicVecVal pcwrite_finishedSeq[SV_PACKED_DATA_NELEMS(11)];
    svLogic addressBuffer_empty;
    svLogicVecVal addressBuffer_rdata[SV_PACKED_DATA_NELEMS(26)];
    svLogic pcread_busValid;
    svLogic pcread_isFeature;
    svLogic pcread_RequestGIBValid;
    ReturnData_t_unpack pread_dataBus;
    svLogic cb_ibfull[6];
    svLogic hcb_isStopable[4];
    svLogic read_isStopable;
    svLogic write_isStopable;
    svLogic weight_isStopable;
}  GIB_inputs;
...
#ifndef MTI_INCLUDED_TYPEDEF_GIB_outputs
#define MTI_INCLUDED_TYPEDEF_GIB_outputs

typedef struct {
    svLogic pif_AddOutput;
    svLogicVecVal endInst_oAddr[SV_PACKED_DATA_NELEMS(26)];
    svLogicVecVal endInst_oSize[SV_PACKED_DATA_NELEMS(26)];
    svLogic addressBuffer_ren;
    svLogic reqGIBValid;
    RequestItem_t_unpack reqGIB;
    svLogic cb_start[4];
    svLogic cb_stop[4];
    svLogic inst_enable[4];
    InstructionHCB_unpack cb_inst[4];
    svLogic cwtinst_enable;
    ...
    svLogicVecVal address[SV_PACKED_DATA_NELEMS(26)];
    svLogic addressValid;
    svLogic fetchMore;
    svLogic endValid;
    svLogicVecVal readLen[SV_PACKED_DATA_NELEMS(7)];
    svLogicVecVal maxLen[SV_PACKED_DATA_NELEMS(7)];
    svLogicVecVal itype[SV_PACKED_DATA_NELEMS(4)];
    svLogic pendingRequest;
    svLogic doDecodeInstruction;
    svLogicVecVal end_reqSeqNum[SV_PACKED_DATA_NELEMS(11)];
    svLogic end_fifo_wen;
}  GIB_outputs;

...
#ifndef MTI_INCLUDED_TYPEDEF_processConvOut_inputs
#define MTI_INCLUDED_TYPEDEF_processConvOut_inputs

typedef struct {
    svLogicVecVal state[SV_PACKED_DATA_NELEMS(4)];
    svLogic enable;
    svLogic isOnOutput;
    svLogic pwrite_isWritable;
    svLogic resBuf_empty;
    svLogic doRes_out;
    svLogic doUpSample_out;
    svLogicVecVal outputBufW1_out[SV_PACKED_DATA_NELEMS(4)];
    svLogicVecVal outFrameSize_out[SV_PACKED_DATA_NELEMS(18)];
    svLogicVecVal outW_out[SV_PACKED_DATA_NELEMS(9)];
    svLogicVecVal outW_out2[SV_PACKED_DATA_NELEMS(9)];
    svLogicVecVal maxpool_stride_out[SV_PACKED_DATA_NELEMS(2)];
    svLogicVecVal outputAddrGap_out[SV_PACKED_DATA_NELEMS(24)];
    svLogicVecVal k_out[SV_PACKED_DATA_NELEMS(3)];
    svLogicVecVal curSeq_out[SV_PACKED_DATA_NELEMS(11)];
    svLogic newWriteInst_out;
    svLogicVecVal outputBufH1_out[SV_PACKED_DATA_NELEMS(4)];
    svLogicVecVal outputIdxMax[SV_PACKED_DATA_NELEMS(4)];
    svLogicVecVal pre_output[12][7][SV_PACKED_DATA_NELEMS(8)];
    svLogicVecVal resBuf[7][SV_PACKED_DATA_NELEMS(8)];
    svLogic set_LastOutput;
    svLogic new_params;
    svLogicVecVal new_outputAddr[SV_PACKED_DATA_NELEMS(26)];
    svLogicVecVal new_outputFrameStart[SV_PACKED_DATA_NELEMS(26)];
    svLogic set_out_params;
    svLogicVecVal new_outputAddr_out[SV_PACKED_DATA_NELEMS(26)];
    svLogicVecVal new_outputFrameStart_out[SV_PACKED_DATA_NELEMS(26)];
}  processConvOut_inputs;

#endif

#ifndef MTI_INCLUDED_TYPEDEF_processConvOut_outputs
#define MTI_INCLUDED_TYPEDEF_processConvOut_outputs

typedef struct {
    svLogic res_en;
    svLogicVecVal pwrite_data[7][SV_PACKED_DATA_NELEMS(8)];
    svLogic pwrite_enable;
    svLogicVecVal pwrite_addr[SV_PACKED_DATA_NELEMS(26)];
    svLogic pwrite_setNextInst;
    svLogicVecVal out_row[SV_PACKED_DATA_NELEMS(4)];
    svLogic reset_state;
    svLogicVecVal outputAddr[SV_PACKED_DATA_NELEMS(26)];
    svLogicVecVal outputFrameStart[SV_PACKED_DATA_NELEMS(26)];
    svLogic reset_isOnOutput;
    svLogicVecVal outputCGIdx[SV_PACKED_DATA_NELEMS(4)];
    svLogicVecVal outputCGIdx0[SV_PACKED_DATA_NELEMS(4)];
    svLogicVecVal outputFrameStart_out[SV_PACKED_DATA_NELEMS(26)];
    svLogicVecVal outputUPSteps[SV_PACKED_DATA_NELEMS(2)];
...
void
compare_outputs(
    const processConvOut_outputs* out_data);

...
#ifndef MTI_INCLUDED_TYPEDEF_interface_inputs
#define MTI_INCLUDED_TYPEDEF_interface_inputs

typedef struct {
    svLogic buf_received;
    svLogicVecVal buffer[40][SV_PACKED_DATA_NELEMS(8)];
    svLogic add_output;
    svLogicVecVal add_output_address[SV_PACKED_DATA_NELEMS(26)];
    svLogicVecVal add_output_size[SV_PACKED_DATA_NELEMS(26)];
    svLogic ren_weight;
    svLogicVecVal read_addr_weight[SV_PACKED_DATA_NELEMS(26)];
    svLogicVecVal read_len_weight[SV_PACKED_DATA_NELEMS(16)];
    svLogic ren_data1;
    svLogicVecVal read_addr_data1[SV_PACKED_DATA_NELEMS(26)];
    svLogicVecVal read_len_data1[SV_PACKED_DATA_NELEMS(16)];
    svLogic wen_data1;
    svLogicVecVal write_addr_data1[SV_PACKED_DATA_NELEMS(26)];
    svLogicVecVal write_len_data1[SV_PACKED_DATA_NELEMS(16)];
    svLogicVecVal write_data_data1[32][SV_PACKED_DATA_NELEMS(8)];
}  interface_inputs;

#endif

#ifndef MTI_INCLUDED_TYPEDEF_interface_outputs
#define MTI_INCLUDED_TYPEDEF_interface_outputs

typedef struct {
    svLogic addrbuf_enable;
    svLogicVecVal inst_address[SV_PACKED_DATA_NELEMS(26)];
    svLogic output_enable;
    svLogicVecVal output_addr[SV_PACKED_DATA_NELEMS(26)];
    svLogicVecVal output_data[32][SV_PACKED_DATA_NELEMS(8)];
    svLogicVecVal output_len[SV_PACKED_DATA_NELEMS(16)];
    svLogicVecVal read_data_weight[32][SV_PACKED_DATA_NELEMS(8)];
    svLogicVecVal read_data_data1[32][SV_PACKED_DATA_NELEMS(8)];
    svLogic output_state;
    svLogicVecVal out_addr[SV_PACKED_DATA_NELEMS(26)];
    svLogicVecVal out_len[SV_PACKED_DATA_NELEMS(26)];
    svLogicVecVal out_size[SV_PACKED_DATA_NELEMS(26)];
}  interface_outputs;
...
void
compare_outputs(
    const interface_outputs* out_data);

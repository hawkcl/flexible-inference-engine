...
#ifndef MTI_INCLUDED_TYPEDEF_ddrreadassist_inputs
#define MTI_INCLUDED_TYPEDEF_ddrreadassist_inputs

typedef struct {
    svLogic req_valid;
    svLogicVecVal req_id[SV_PACKED_DATA_NELEMS(4)];
    svLogicVecVal req_addr[SV_PACKED_DATA_NELEMS(26)];
    svLogicVecVal req_len[SV_PACKED_DATA_NELEMS(16)];
    svLogicVecVal ddr_vid[SV_PACKED_DATA_NELEMS(4)];
    svLogicVecVal ddr_data[32][SV_PACKED_DATA_NELEMS(8)];
    svLogic ddr_isLast;
}  ddrreadassist_inputs;

#endif

#ifndef MTI_INCLUDED_TYPEDEF_ddrreadassist_outputs
#define MTI_INCLUDED_TYPEDEF_ddrreadassist_outputs

typedef struct {
    svLogic read_ready;
    svLogicVecVal valid_id[SV_PACKED_DATA_NELEMS(4)];
    svLogicVecVal valid_data[33][SV_PACKED_DATA_NELEMS(8)];
    svLogicVecVal axi_rid[SV_PACKED_DATA_NELEMS(4)];
    svLogicVecVal axi_raddr[SV_PACKED_DATA_NELEMS(26)];
    svLogicVecVal axi_len[SV_PACKED_DATA_NELEMS(5)];
    svLogic read_request;
    svLogic read_freeze;
    svLogicVecVal next_addr[SV_PACKED_DATA_NELEMS(26)];
    svLogicVecVal buf_addr[SV_PACKED_DATA_NELEMS(16)];
    svLogicVecVal saved_buf[32][SV_PACKED_DATA_NELEMS(8)];
    svLogicVecVal data_next[33][SV_PACKED_DATA_NELEMS(8)];
...
void
compare_outputs(
    const ddrreadassist_outputs* out_data);

...
#ifndef MTI_INCLUDED_TYPEDEF_HCBCtrl_inputs
#define MTI_INCLUDED_TYPEDEF_HCBCtrl_inputs
...
typedef struct {
    ...
    svLogic doRes;
    svLogic isOnOutput;
    svLogic reset_isOnOutput;
    svLogic BM_enough_data;
    svLogic w_enough_data;
    svLogicVecVal receivedRes[SV_PACKED_DATA_NELEMS(16)];
    svLogicVecVal totalRes[SV_PACKED_DATA_NELEMS(16)];
    svLogic input_fifo_empty;
    ...
    svLogicVecVal kOut[SV_PACKED_DATA_NELEMS(11)];
...
#ifndef MTI_INCLUDED_TYPEDEF_HCBCtrl_outputs
#define MTI_INCLUDED_TYPEDEF_HCBCtrl_outputs

typedef struct {
    svLogic startPrefetching;
    svLogic startConvOut;
    svLogicVecVal BMlen[SV_PACKED_DATA_NELEMS(4)];
    svLogicVecVal wlenk[SV_PACKED_DATA_NELEMS(4)];
    svLogic enSendBMWeights;
    svLogic enSendWeights;
    svLogic isBMWeightValid;
    svLogic isWeightValid;
    svLogicVecVal weightId[SV_PACKED_DATA_NELEMS(4)];
    svLogic sendBackUpInput_valid;
    svLogicVecVal backupId[SV_PACKED_DATA_NELEMS(3)];
    svLogic isOutputReady;
    svLogic nextWeight;
    svLogicVecVal readWidth[SV_PACKED_DATA_NELEMS(4)];
    svLogicVecVal rowNum[SV_PACKED_DATA_NELEMS(6)];
    svLogic reset_iLayers;
    svLogic loadNextInst;
    svLogic isPrefetchNextVolume_next;
    svLogic isPrefetchNextVolume;
    svLogicVecVal workingProgress_o[SV_PACKED_DATA_NELEMS(11)];
    svLogic doAssemble_o;
    svLogicVecVal usedWords_o[SV_PACKED_DATA_NELEMS(17)];
    svLogic isInitLayer_o;
    svLogic isReadingFeatures_o;
    svLogic isLoadingFroze_o;
    svLogic hasNextFeatureParams_o;
    svLogic isLoadingNextFeatures_o;
    svLogic isLReluWeight_o;
    svLogicVecVal iterCountDown_o[SV_PACKED_DATA_NELEMS(3)];
    svLogicVecVal outputReadPos_o[SV_PACKED_DATA_NELEMS(4)];
    svLogicVecVal outputWritePos_o[SV_PACKED_DATA_NELEMS(4)];
    svLogicVecVal state_o[SV_PACKED_DATA_NELEMS(4)];
    svLogicVecVal state_next_o[SV_PACKED_DATA_NELEMS(4)];
    svLogicVecVal outputBufH1_o[SV_PACKED_DATA_NELEMS(4)];
    svLogic isNextVolumeReady_o;
    svLogic bmPhase_o;
    svLogic isRunning_o;
    svLogic is_cycle_froze;
    svLogicVecVal maxRowCount[SV_PACKED_DATA_NELEMS(5)];
    svLogicVecVal lastLen[SV_PACKED_DATA_NELEMS(4)];
    svLogicVecVal input_src[SV_PACKED_DATA_NELEMS(3)];
    svLogicVecVal outLayerCount[SV_PACKED_DATA_NELEMS(11)];
    svLogicVecVal initFSteps[SV_PACKED_DATA_NELEMS(3)];
    svLogicVecVal initWSteps[SV_PACKED_DATA_NELEMS(4)];
    svLogicVecVal initBMWSteps[SV_PACKED_DATA_NELEMS(4)];
    svLogicVecVal layerCount[SV_PACKED_DATA_NELEMS(11)];
    svLogicVecVal usedGroups[SV_PACKED_DATA_NELEMS(4)];
    svLogicVecVal wtotal[SV_PACKED_DATA_NELEMS(4)];
    svLogicVecVal wlen[SV_PACKED_DATA_NELEMS(4)];
    unsigned int tm;
}  HCBCtrl_outputs;
...
void
compare_outputs(
    const HCBCtrl_outputs* out_data);

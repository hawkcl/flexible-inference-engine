...
#ifndef MTI_INCLUDED_TYPEDEF_shiftinput_inputs
#define MTI_INCLUDED_TYPEDEF_shiftinput_inputs
...
#ifndef MTI_INCLUDED_TYPEDEF_shiftinput_outputs
#define MTI_INCLUDED_TYPEDEF_shiftinput_outputs
...
void
compare_outputs(
    const shiftinput_outputs* out_data);

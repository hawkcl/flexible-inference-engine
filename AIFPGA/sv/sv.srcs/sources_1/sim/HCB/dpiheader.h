...
#ifndef MTI_INCLUDED_TYPEDEF_HCB_inputs
#define MTI_INCLUDED_TYPEDEF_HCB_inputs
...
typedef struct {
    ...
    svLogicVecVal pcweight_dataBus[32][SV_PACKED_DATA_NELEMS(8)];
...
#ifndef MTI_INCLUDED_TYPEDEF_HCB_outputs
#define MTI_INCLUDED_TYPEDEF_HCB_outputs

typedef struct {
    uint64_t tm;
    svLogic weights_almost_full;
    svLogic instfifo_full;
    svLogic token_set;
    svLogicVecVal max_token[SV_PACKED_DATA_NELEMS(2)];
    svLogic pread_RequestValid;
    ...
    svLogic isFetchNextInst;
    svLogicVecVal workingProgress[SV_PACKED_DATA_NELEMS(11)];
    svLogic isRunning;
    svLogic isReadingFeatures;
    svLogicVecVal reqFeature[SV_PACKED_DATA_NELEMS(11)];
    svLogicVecVal finishedSeq[SV_PACKED_DATA_NELEMS(11)];
    svLogicVecVal workingSeq[SV_PACKED_DATA_NELEMS(11)];
    svLogic isReadingWeights;
    svLogicVecVal reqWeight[SV_PACKED_DATA_NELEMS(11)];

...
#ifndef MTI_INCLUDED_TYPEDEF_buildInputFifo_inputs
#define MTI_INCLUDED_TYPEDEF_buildInputFifo_inputs
...
typedef struct {
    ...
    svLogic reset_params;
    svLogic new_params;
    svLogic reset_iLayers;
    svLogicVecVal new_rowAddr[SV_PACKED_DATA_NELEMS(6)];
    svLogic input_full;
    svLogicVecVal ab_data[12][SV_PACKED_DATA_NELEMS(8)];
    svLogic ab_empty;
}  buildInputFifo_inputs;

#endif

#ifndef MTI_INCLUDED_TYPEDEF_buildInputFifo_outputs
#define MTI_INCLUDED_TYPEDEF_buildInputFifo_outputs

typedef struct {
    svLogic input_wr_en;
    svLogicVecVal input_data_out[12][SV_PACKED_DATA_NELEMS(8)];
    svLogic ab_rd_en;
...
void
compare_outputs(
    const buildInputFifo_outputs* out_data);

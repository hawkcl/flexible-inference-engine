...
#ifndef MTI_INCLUDED_TYPEDEF_sendBackUpInput_inputs
#define MTI_INCLUDED_TYPEDEF_sendBackUpInput_inputs

typedef struct {
    svLogic sendBackUpInput_valid;
    svLogicVecVal backupId[SV_PACKED_DATA_NELEMS(3)];
    svLogicVecVal fifo_data[12][SV_PACKED_DATA_NELEMS(8)];
    svLogic fifo_empty;
...
#ifndef MTI_INCLUDED_TYPEDEF_sendBackUpInput_outputs
#define MTI_INCLUDED_TYPEDEF_sendBackUpInput_outputs

typedef struct {
    svLogic rd_en;
    svLogicVecVal shiftBufBackup[7][6][SV_PACKED_DATA_NELEMS(8)];
...
void
compare_outputs(
    const sendBackUpInput_outputs* out_data);
...
void
read_inputs(
    sendBackUpInput_inputs* in_data);

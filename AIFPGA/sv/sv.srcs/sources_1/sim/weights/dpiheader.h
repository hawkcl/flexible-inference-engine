...
#ifndef MTI_INCLUDED_TYPEDEF_weight_inputs
#define MTI_INCLUDED_TYPEDEF_weight_inputs

typedef struct {
    svLogic enSendWeights;
    svLogic enSendBMWeights;
    svLogic is_cycle_froze;
    svLogicVecVal len[SV_PACKED_DATA_NELEMS(4)];
    svLogicVecVal bm_len[SV_PACKED_DATA_NELEMS(4)];
    svLogic isRunning;
    svLogic pcweight_busValid;
    svLogicVecVal pcweight_seq[SV_PACKED_DATA_NELEMS(11)];
    svLogic new_weight_params;
    svLogicVecVal new_weightReadPos[SV_PACKED_DATA_NELEMS(5)];
    svLogicVecVal new_nextWeightRead[SV_PACKED_DATA_NELEMS(27)];
    svLogicVecVal new_endWeightRead[SV_PACKED_DATA_NELEMS(27)];
    svLogicVecVal new_reqSeqW[SV_PACKED_DATA_NELEMS(11)];
    svLogicVecVal w_bus[32][SV_PACKED_DATA_NELEMS(8)];
    svLogic new_conv_inst;
}  weight_inputs;

#endif

#ifndef MTI_INCLUDED_TYPEDEF_weight_outputs
#define MTI_INCLUDED_TYPEDEF_weight_outputs

typedef struct {
    svLogicVecVal weightsBus[8][SV_PACKED_DATA_NELEMS(8)];
    svLogicVecVal fifodata[8][SV_PACKED_DATA_NELEMS(8)];
    svLogic bm_enough_data;
    svLogic enough_data;
    svLogic isReadingWeights;
    svLogicVecVal weightReadPos[SV_PACKED_DATA_NELEMS(5)];
    svLogicVecVal nextWeightRead[SV_PACKED_DATA_NELEMS(27)];
    svLogicVecVal endWeightRead[SV_PACKED_DATA_NELEMS(27)];
    svLogicVecVal numBuf[SV_PACKED_DATA_NELEMS(5)];
    svLogic wr_en;
    svLogic rd_en;
}  weight_outputs;

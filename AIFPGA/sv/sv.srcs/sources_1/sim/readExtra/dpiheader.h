...
#ifndef MTI_INCLUDED_TYPEDEF_rex_inputs
#define MTI_INCLUDED_TYPEDEF_rex_inputs

typedef struct {
    svLogic isReadingFeatures;
    svLogic pread_RequestFull;
    svLogic isResMaster;
    svLogicVecVal this_token[SV_PACKED_DATA_NELEMS(2)];
    svLogicVecVal ptoken[SV_PACKED_DATA_NELEMS(2)];
    svLogic res_full;
    svLogic doRes;
    svLogicVecVal mode[SV_PACKED_DATA_NELEMS(2)];
    ...
    svLogicVecVal curSeq[SV_PACKED_DATA_NELEMS(8)];
    svLogicVecVal ks[SV_PACKED_DATA_NELEMS(11)];
    ...
    svLogic resetRequestingRes;
    svLogic extWeights_ren;
    svLogic resBuf_ren;
}  rex_inputs;

#endif

#ifndef MTI_INCLUDED_TYPEDEF_rex_outputs
#define MTI_INCLUDED_TYPEDEF_rex_outputs

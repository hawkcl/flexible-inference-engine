...
#ifndef MTI_INCLUDED_TYPEDEF_ctrlweight_inputs
#define MTI_INCLUDED_TYPEDEF_ctrlweight_inputs

typedef struct {
    svLogic cwinst_enable;
    InstructionWeight_unpack cwinst;
    svLogic ddr_read_ready;
    svLogicVecVal valid_id[SV_PACKED_DATA_NELEMS(4)];
    svLogicVecVal weight_data[32][SV_PACKED_DATA_NELEMS(8)];
    svLogic cb_isReadingWeights[4];
    svLogic cb_isWeightFull[4];
    svLogicVecVal cb_ReqWeight[4][SV_PACKED_DATA_NELEMS(11)];
}  ctrlweight_inputs;

#endif

#ifndef MTI_INCLUDED_TYPEDEF_ctrlweight_outputs
#define MTI_INCLUDED_TYPEDEF_ctrlweight_outputs

typedef struct {
    svLogic weight_ram_enable;
    svLogicVecVal weight_ddr_id[SV_PACKED_DATA_NELEMS(4)];
    svLogicVecVal weight_ram_addr[SV_PACKED_DATA_NELEMS(26)];
    ...
    svLogic hasMoreData;
    svLogicVecVal nextReadAddr[SV_PACKED_DATA_NELEMS(26)];
    svLogicVecVal dataIdx[SV_PACKED_DATA_NELEMS(2)];
    svLogic saved_enable;
    svLogic read_mem;
    svLogic data_fifo_ren;
    svLogic data_fifo_wen;
    svLogic data_fifo_empty;
    svLogic data_fifo_progfull;
    svLogic weight_mem_ren;
    svLogic weight_mem_wen;
    svLogicVecVal mode[SV_PACKED_DATA_NELEMS(2)];
}  ctrlweight_outputs;
...
void
compare_outputs(
    const ctrlweight_outputs* out_data);

...
#ifndef MTI_INCLUDED_TYPEDEF_startConvOut_inputs
#define MTI_INCLUDED_TYPEDEF_startConvOut_inputs

typedef struct {
    svLogic enable;
    svLogic isNextVolumeReady;
...
#ifndef MTI_INCLUDED_TYPEDEF_startConvOut_outputs
#define MTI_INCLUDED_TYPEDEF_startConvOut_outputs
...
typedef struct {
    ...
    svLogicVecVal outputAddr_out[SV_PACKED_DATA_NELEMS(26)];
...
void
compare_outputs(
    const startConvOut_outputs* out_data);
